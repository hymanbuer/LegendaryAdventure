...
window.boot = function () {
    ...
    function runCallback() {
        ...
        if (initTime >= leastInitTime) {
            ...
            window.setTimeout(onStart, leastInitTime - initTime)
        } else {
            onStart();
        }
    }

    cc.game.run(option, runCallback);
};

// main.5de91.js is qqplay and jsb platform entry file, so we must leave platform init code here
if (false) {
